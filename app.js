...
const galleryList = document.querySelector(".js-galerry");
const bacdrop = document.querySelector(".bacdrop");
const modal = document.querySelector(".modal");

function createImage() {
    const createGalery = galleryItems.map((objet) => {
        const img = `        
        <li class="gallery__item">
            <img class="gallery__image"
                data-source="${objet.original}"
                src="${objet.preview}" alt="${objet.description}" />
    </li>`;
